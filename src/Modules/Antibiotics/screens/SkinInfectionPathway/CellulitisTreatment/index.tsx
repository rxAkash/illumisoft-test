...
import { SKIN_INFECTION_CELLULITIS, SKIN_INFECTION_DRUG_DISPLAY } from 'Modules/Antibiotics/navigation/routes';
import { NavigationProp } from '@react-navigation/native';
import HomeButton from 'Modules/Antibiotics/components/HomeButton';
import { FIRST_LINE, SEVERE_PENICILLIN_TREATMENT } from './conf';

interface Props {
  navigation: NavigationProp<any>;
}

const CellulitisTreatment = React.memo(({navigation}: Props) => {
    ...
    >
      <View style={styles.container}>
        ...
        <ExpandableSection
          ...
          analyticsScreenName={SKIN_INFECTION_CELLULITIS}
        >
          <TreatmentDisplay
            config={FIRST_LINE}
        ...
        <ExpandableSection
          title={antibioticsText.skinInfection.mrsaSuspected}
          backgroundColor={strongAntibioticsColor}
          analyticsScreenName={SKIN_INFECTION_CELLULITIS}
        >
          <TreatmentDisplay
            config={SEVERE_PENICILLIN_TREATMENT}
            onDrugPress={onDrugPress}
          />
        </ExpandableSection>
        <HomeButton />
...
export default CellulitisTreatment;
