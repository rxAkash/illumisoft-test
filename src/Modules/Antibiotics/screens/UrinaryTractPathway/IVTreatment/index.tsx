...
import { URINARY_TRACT_DRUG_INFO, URINARY_TRACT_IV_TREATMENT } from 'Modules/Antibiotics/navigation/routes';
...
const UrinaryTractIVTreatment = React.memo(({navigation}: Props) => {
  const onDrugPress = (drugInfo: any) => {
    navigation.navigate(URINARY_TRACT_DRUG_INFO, {
      title: antibioticsText.urinaryTract.ivTreatment,
      drugConfig: drugInfo
    })
  }
    ...
    >
      <View style={styles.container}>
        ...
        <ExpandableSection
          ...
          analyticsScreenName={URINARY_TRACT_IV_TREATMENT}
        >
          <TreatmentDisplay
...
export default UrinaryTractIVTreatment;
