...
export const A_12U_SCORING = {
  name: "ESI score",
  title: "Calculate Respiratory Score",
  age: "(> 12yrs)",
  EC: "Screen Access",
  EA: "A_12U_SCORING",
  EA_ENDSCORE: "A_12U_RS_ENDSCORE",
  Description: "User selected the “>12 Years” age from the A_AGE_SELECTION",
  scores: [
    {
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          points: 1,
          EC: "User Decision",
          EA: "A_12U_RS_RETRACTIONS_SUBCOSTAL"
        },
        {
          title: "Intercostal",
          ...
          points: 1,
          EC: "User Decision",
          EA: "A_12U_RS_RETRACTIONS_INTERCOSTAL"
        },
        {
          title: "Substernal",
          ...
          points: 1,
          EC: "User Decision",
          EA: "A_12U_RS_RETRACTIONS_SUBSTERNAL"
        },
        {
          title: "Suprasternal",
          ...
          points: 1,
          EC: "User Decision",
          EA: "A_12U_RS_RETRACTIONS_SUPRASTERNAL"
        },
        {
          ...
          points: 1,
          EC: "User Decision",
          EA: "A_12U_RS_RETRACTIONS_SUPRACLAVICULAR"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          points: 1,
          EC: "User Decision",
          EA: "A_12U_RS_AUSC_DIMINISHEDSOUNDS"
        }
      ]
    }
  ]
