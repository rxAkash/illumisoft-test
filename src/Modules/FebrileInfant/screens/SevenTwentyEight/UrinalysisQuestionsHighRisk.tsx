...
import {ADMISSION_RECOMMENDATIONS, ADMISSION_RECOMMENDATIONS_HIGH_RISK } from './routes';
import SevenTwentyEightLayout from './SevenTwentyEightLayout';
import YesNoQuestion from 'UIToolkit/YesNoQuestion';
import { useFocusEffect } from '@react-navigation/native';

const UrinalysisQuestionsHighRisk = React.memo(() => {
  ...
  useFocusEffect(
    ...
    return (
      <SevenTwentyEightLayout
        ...
        bottomButtonRoute={ADMISSION_RECOMMENDATIONS_HIGH_RISK}
      >
        <YesNoQuestion 
         id={1} 
         answer={answers[1]}
  ...
  export default UrinalysisQuestionsHighRisk;
