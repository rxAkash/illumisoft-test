...
const DispositionRecommendationsHIMTen = React.memo(({ navigation }: Props) => {
    ...
    >
      <View style={styles.titleContainer}>
        <Text style={styles.blueTextTitile}>
          {headInjuryText.tenToTwentyThreePathway.DisposistionRecommnedation.title}
        </Text>
        <Text style={styles.blueTextTitile}>
          {headInjuryText.tenToTwentyThreePathway.DisposistionRecommnedation.months}
        </Text>
...
export default DispositionRecommendationsHIMTen;
