...
import {DISPOSITION_RECCOMENDATION_HMI, DISPOSITION_RECCOMENDATION_HMI_TEN, HEAD_INJURY_HOME  } from "../../../navigation/routes"
...
const PhysicalExamTen = React.memo(({ navigation }: Props) => {
  ...
  const findResultFromAnswers = (newAnswers: {id: number, answer: number}[]) => {
    ...
    console.log(answerValues);
      ...
      return DISPOSITION_RECCOMENDATION_HMI_TEN;
    //}
    ...
    >
      <View style={styles.titleContainer}>
          <Text style={styles.blueTextTitile}>
            {headInjuryText.tenToTwentyThreePathway.PhysicalExam.title}
          </Text>
        <Text style={styles.regularText}>{headInjuryText.tenToTwentyThreePathway.PhysicalExam.question}</Text>
...
export default PhysicalExamTen;
