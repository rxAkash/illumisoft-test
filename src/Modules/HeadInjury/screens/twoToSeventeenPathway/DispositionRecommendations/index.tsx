...
const DispositionRecommendationsHIMTwo = React.memo(({ navigation }: Props) => {
    ...
    >
      <View style={styles.titleContainer}>
        <Text style={styles.blueTextTitile}>
          {headInjuryText.twoToSeventeenPathway.DisposistionRecommnedation.title}
        </Text>
        <Text style={styles.blueTextTitile}>
          {headInjuryText.twoToSeventeenPathway.DisposistionRecommnedation.months}
        </Text>
...
export default DispositionRecommendationsHIMTwo;
