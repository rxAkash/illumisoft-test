...
import { DISABILITY_ASSESSMENT_TWO } from "Modules/HeadInjury/navigation/routes";

interface Props {
  navigation: NavigationProp<any>;
}

const PrimaruSurveyTWO = React.memo(({ navigation }: Props) => {
  const onNav = () => {
    navigation.navigate(DISABILITY_ASSESSMENT_TWO);
  };
...
export default PrimaruSurveyTWO;
