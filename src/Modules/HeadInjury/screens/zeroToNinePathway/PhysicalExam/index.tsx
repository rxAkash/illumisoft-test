...
const PhysicalExam = React.memo(({ navigation }: Props) => {
  ...
  const findResultFromAnswers = (newAnswers: {id: number, answer: number}[]) => {
    ...
    console.log(answerValues);
      ...
      return DISPOSITION_RECCOMENDATION_HMI;
    //}
    ...
    >
      <View style={styles.titleContainer}>
          <Text style={styles.blueTextTitile}>
            {headInjuryText.zeroToNinePathway.PhysicalExam.title}
          </Text>
        <Text style={styles.regularText}>{headInjuryText.zeroToNinePathway.PhysicalExam.question}</Text>
