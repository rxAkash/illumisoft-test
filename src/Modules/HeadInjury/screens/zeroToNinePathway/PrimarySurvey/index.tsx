...
import { DISABILITY_ASSESSMENT } from "Modules/HeadInjury/navigation/routes";

interface Props {
  navigation: NavigationProp<any>;
}

const PrimaruSurvey = React.memo(({ navigation }: Props) => {
  const onNav = () => {
    navigation.navigate(DISABILITY_ASSESSMENT);
  };
